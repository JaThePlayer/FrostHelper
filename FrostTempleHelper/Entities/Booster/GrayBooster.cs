...
namespace FrostHelper
{
    ...
    [Tracked]
    public class GrayBooster : Entity
    {
        ...
        public GrayBooster(EntityData data, Vector2 offset) : base(data.Position + offset)
        {
            base.Depth = -8500;
            base.Collider = new Circle(10f, 0f, 2f);
            this.sprite = new Sprite(GFX.Game, data.Attr("directory", "objects/FrostHelper/grayBooster/"));
            sprite.Visible = true;
            sprite.CenterOrigin();
        ...
        public static void Boost(Player player, GrayBooster booster)
        {
            player.StateMachine.State = FrostHelper.FrostModule.grayBoostState;
