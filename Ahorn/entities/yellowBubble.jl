...
@mapdef Entity "FrostHelper/YellowBooster" FrostHelperYellowBoosterPlacement(x::Integer, y::Integer, boostTime::Number=0.3, respawnTime::Number=1.0, particleColor::String="Yellow", flashTint::String="Red", directory="objects/FrostHelper/yellowBooster/", reappearSfx::String="event:/game/04_cliffside/greenbooster_reappear", enterSfx::String="event:/game/04_cliffside/greenbooster_enter", boostSfx::String="event:/game/04_cliffside/greenbooster_dash", releaseSfx::String="event:/game/04_cliffside/greenbooster_end")
