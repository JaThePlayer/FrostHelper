...
public class YellowBooster : GenericCustomBooster {
    ...
    public override IEnumerator HandleBoostCoroutine(Player player) {
        ...
        // BUG: if you're invincible, this doesn't kill you and let you stay in the booster forever
        //      this could be really cool for some setups, so I'm leaving this alone
