...
[Tracked]
public class YellowBoosterOLD : Entity {
    ...
    public YellowBoosterOLD(EntityData data, Vector2 offset) : base(data.Position + offset) {
        Depth = -8500;
    ...
    public static void Boost(Player player, YellowBoosterOLD booster) {
