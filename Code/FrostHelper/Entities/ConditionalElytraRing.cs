...
// https://github.com/CommunalHelper/CommunalHelper/blob/dev/src/Entities/Elytra/ElytraBoostRing.cs
// TODO: Work out visuals, and PR to Communal Helper!
[CustomEntity("FrostHelper/ConditionalElytraBoostRing")]
internal sealed class ElytraBoostRing : ElytraRing
{
    private struct Line
    {
    ...
    public ElytraBoostRing(Vector2 a, Vector2 b, float speed, float duration, bool refill, bool bidirectional, ConditionHelper.Condition condition)
        : base(a, b, Color.Teal)
    {
        this.speed = speed;
    ...
    private bool Enabled() {
        return _condition.Check(Scene.ToLevel().Session);
    }
    ...
    public override void OnPlayerTraversal(Player player, int sign, bool shake = true) {
        ...
        base.OnPlayerTraversal(player, sign, shake);
